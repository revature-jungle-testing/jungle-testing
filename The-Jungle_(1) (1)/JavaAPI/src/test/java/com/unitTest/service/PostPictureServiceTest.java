...
public class PostPictureServiceTest<Picture> {
    ...
    // Negative Test
    @Test
    public void serviceCreatePostNegative(){
    PostPicture newPost = new PostPicture(0, null);
    newPost.setPostId(1);
    newPost.setPictureId(1);
    try {
        postPictureService.createPictureService(newPost);
    } catch(InvalidInputException e) {
        Assert.assertEquals("Your picture is tp big", e.getMessage());
    }
   }

   
    @Test
    public void getAllPicturesNegativeTest() {
        PostPicture result = postPictureService.getAllPicturesService(0);
